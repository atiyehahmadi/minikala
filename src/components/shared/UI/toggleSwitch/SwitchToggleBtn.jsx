...
const SwitchToggleBtn = ({ id }) => {
  return (
    ...
    >
      ...
      />
      <div
        className="w-8 h-4 bg-white border border-neutral-300 peer-focus:outline-none 
               rounded-full peer dark:bg-neutral-700 peer-checked:after:translate-x-full
               peer-checked:after:border-white after:content-[''] after:absolute 
               after:top-[2px] after:left-[4px] after:bg-neutral-400 after:border-neutral-300 
