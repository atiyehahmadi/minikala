...
const Login = () => {
  ...
  const [classes, setClasses] = useState(
    "outline-none bg-neutral-200 lg:bg-white border-b-2 lg:border border-teal-400 focus:border-teal-400 caret-teal-400 rounded-lg w-full p-3 mt-4"
  );
  const loginHandler = () => {
  ...
  const errorMessageHandler = () => {
    mobileValidationError
      ? inputValue
        ? setErrorMessage("شماره موبایل نادرست است")
  ...
  const inputStyleHandler = () => {
    mobileValidationError
      ? setClasses(
          "outline-none bg-neutral-200 lg:bg-white border-b-2 lg:border border-red-400 focus:border-red-400 caret-red-400 rounded-lg w-full p-3 mt-4"
        )
      : inputValue
      ? setClasses(
          "outline-none bg-neutral-200 lg:bg-white border-b-2 lg:border border-teal-400 focus:border-teal-400 caret-teal-400 rounded-lg w-full p-3 mt-4"
