...
import ClubPointIcon from "../../assets/images/icons/ClubPoint.svg";
import FreeDelivery from "../../assets/images/icons/FreeDelivery.svg";
        ...
        <div className="w-full border-b border-neutral-300 my-2">
          <div className="flex lg:w-1/4">
            <div className="flex gap-1 w-full items-center lg:justify-start justify-center font-bold active:border-b-2 active:border-red-500 cursor-pointer py-2">
              ...
              <span className="bg-red-500 mx-1 text-white text-xs rounded-full p-1 text-center w-6 h-6">
                {shoppingBasketInfo.totalquantity}
              </span>
            </div>
          </div>
        </div>
            ...
            <div className="lg:border lg:border-neutral-300 lg:rounded-lg w-full pt-4">
              <div className="px-4">
                ...
                <p className="text-neutral-400 text-xs py-2">
                  {shoppingBasketInfo.totalquantity} کالا
                </p>
              </div>
              <div className="">
                {shoppingBasketInfo.shoppingBasket.map((item, index) => (
                  <CheckoutCard key={index} dataList={item} />
                ))}
              </div>
            </div>
            {isDesktop ? (
              <div className="flex flex-col gap-3 w-106">
                <div className="border border-neutral-300 rounded-lg text-neutral-500 text-sm">
                  <div className="flex flex-col gap-5 p-4">
                    ...
                    <p className="text-[11px] text-neutral-500">
                      هزینه ارسال براساس آدرس، زمان تحویل، وزن و حجم مرسوله شما
                      محاسبه می‌شود
                    </p>
                    <div className="flex justify-between font-bold text-red-500">
                      <p>سود شما از خرید</p>
                      <p>
                        {shoppingBasketInfo.priceBeforeOff -
                          shoppingBasketInfo.priceAfterOff}{" "}
                        تومان
                      </p>
                    </div>
                    <button className="bg-red-500 text-white font-bold text-center rounded-lg py-3">
                      ادامه
                    </button>
                  </div>
                  <div className="flex justify-between bg-neutral-100 rounded-b-lg p-4">
                    <div className="flex gap-1 items-center">
                      <img src={ClubPointIcon} alt="" />
                      <p>مینی‌کلاب</p>
                    </div>
                    <p>126 امتیاز</p>
                  </div>
                ...
                <div className="flex flex-shrink flex-col gap-2 border border-neutral-300 rounded-lg p-4">
                  <div className="flex flex-shrink justify-between items-end">
                    <div className="flex gap-1 items-end">
                      <SparklesIcon className="shrink w-4 h-4 text-[#b4278a]" />
                      <p className="shrink text-xs text-neutral-700 font-semibold">
                        مزایای پلاس برای این سفارش
                      </p>
                    </div>
                  ...
                  <div className="flex gap-2">
                    <div>
                      <p className="text-neutral-300 font-bold text-[8px] px-0.6">
                        |
                      </p>
                      <img
                        src="https://img.icons8.com/emoji/48/000000/purple-circle-emoji.png"
                        className="w-1.5 h-1.5"
                        alt=""
                      />
                      <p className="text-neutral-300 font-bold text-[12px] px-0.6">
                        |
                      </p>
                      <img
                        src="https://img.icons8.com/emoji/48/000000/purple-circle-emoji.png"
                    ...
                    <div className="">
                      <p className="shrink text-[11px] text-neutral-500 pt-2">
                        25,048 تومان هدیه نقدی
                      </p>
                      <p className="text-[11px] text-neutral-500 pt-2">
                        بازگشت تا ۳۰ روز پس از تحویل
                      </p>
                    </div>
                  </div>
                </div>
                <div className="flex justify-between border border-neutral-300 rounded-lg">
                  <div className="p-2">
              ...
              <div className="flex justify-between items-center sticky bottom-0 border-t border-neutral-300 bg-white py-4">
                <button className="bg-red-500 text-white font-bold text-center rounded-lg py-3 w-1/2">
                  ادامه
                </button>
                <div className="flex flex-col gap-2 text-xs font-semibold">
                  <p className="text-neutral-600">جمع سبد خرید</p>
                  <p className="text-left">
                    {shoppingBasketInfo.priceBeforeOff} تومان
                  </p>
                </div>
              </div>
            )}
