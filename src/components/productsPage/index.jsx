    ...
    <MainLayout>
      <div className="p-4 bg-white">
        <p className="text-neutral-500 text-xs">
          {" "}
          فروشگاه اینترنتی مینی‌کالا /
        </p>
        <ProductCategory />
        <div className="flex gap-4 w-full py-4">
          {isDesktop && (
            <div className="flex flex-col gap-4 xl:w-1/4 lg:w-1/3">
              <ProductAdvertisementCard />
              <FilterMenu classes="sticky top-0 border border-neutral-200" />
            </div>
          )}
          <div className="py-2 w-full">
            {isDesktop ? <ProductsGrid /> : <ProductsGridMobile />}
          </div>
        </div>
      </div>
    </MainLayout>
