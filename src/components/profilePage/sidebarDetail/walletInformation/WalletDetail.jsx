  ...
  return (
    <>
      ...
      <div className="flex justify-between bg-red-50 rounded-lg px-4 py-10">
        ...
        <button
          type="button"
          className="items-center bg-red-600 rounded-lg text-white mr-auto hover:bg-red-700 px-8"
        >
          برداشت از کیف پول
        </button>
      </div>
      <div className="grid grid-cols-5 pr-4 pt-12 ">
        <div className="col-span-2 pl-2">
          ...
          <p className="text-sm">
            مبلغ مورد نیاز خود را وارد نمایید یا از میان مبالغ پیشنهادی یک گزینه
            انتخاب نمایید
          </p>
        </div>
        <div className="col-span-3">
          <input
            type="text"
            className="outline-none border border-neutral-300 rounded-lg align-middle w-full p-4"
            placeholder="مبلغ دلخواه شما (ریال)"
          />
          <div className="flex flex-grow gap-2 py-4 w-full">
            {moneyButton.map((item, index) => (
              <button
                type="button"
                className="shrink-0 bg-neutral-200 text-sm text-neutral-700 rounded-lg lg:px-4 px-2 py-1.5"
              >
                {item} ریال
              </button>
            ))}
      ...
      <div className="flex text-red-600 items-center py-4 pr-4 ">
        ...
        <button
          type="button"
          className="hover:bg-neutral-100 rounded-md text-sm p-2 "
        >
          تاریخچه تراکنش ها
        </button>
      </div>
      <div className="flex justify-end items-center text-sm">
        ...
        <button
          type="button"
          className="bg-red-400 rounded-lg text-white px-6 py-2 mr-3"
        >
          {" "}
          شارژ کیف پول{" "}
        </button>
